<div id="arcarbon-map-farmer">
    ...
    <div class="row ar-map-full ar-map-container">
            ...
            <div>
                <div class="row">
                    ...
                    if (is_user_logged_in()) {
                        echo "<h5 class='arcarbon-map-h5'> Welcome back  </h5>";
                        echo "<h4 class='arcarbon-map-h4'><b>" . $current_user->user_firstname . " " . $current_user->user_lastname . "</b></h4>";
                    }
                    else {
                        echo "<h5 class='arcarbon-map-h5'> </h5><h4 class='arcarbon-map-h4'>Please Log In</h4>";
                    }
                    ?>
                    </div>
                </div>
                ...
                <div class="row ar-map-total ar-map-pad-top ar-map-unmargin-bot-row ">
                    ...
                    <div class="col s6">
                        <h5 class='arcarbon-map-h5'> Total Hectares</h5>
                    </div>
        ...
        <div id="intersects" class="modal">
            ...
            <h4 class='arcarbon-map-h4'>Your fields can not overlap!</h4>
        ...
        <div id="overfifty" class="modal">
            <div class="modal-content">
            <h4 class='arcarbon-map-h4'>Your total hectares has exceeded 50!</h4>
        ...
        <div id="submit" class="modal">
            <div class="modal-content">
            <h4 class='arcarbon-map-h4'>Your new plots have been submitted</h4>
        ...
        <div id="confirm-submit" class="modal">
            <div class="modal-content">
            <h4 class='arcarbon-map-h4'>Once you have submitted you can not change your drawings</h4>
        ...
        <div id="submit-error" class="modal">
            <div class="modal-content">
            <h4 class='arcarbon-map-h4'>Something appears to have gone wrong</h4>
        ...
        <div id="field-text-edit" class="modal" data-keyboard="false">
            <div class="modal-content">
             <h4 class='arcarbon-map-h4'>Tell us a little about this plot...</h4>
             <br>
